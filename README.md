...
![Game ScreenShot Desktop App](imgs\Desktop.JPG "Desktop")

- Tablet screen

![Game ScreenShot Table App](imgs\Ipad.JPG "ipad")

- Phone screen

![Game ScreenShot Phone App](imgs\iphone.JPG "iphone")
...
![User interaction Flow Chart](imgs\chessFlowChart.jpg "User interaction")

The following illustrate the flow of how we determine which tile to highlight after clicking the piece:

![Piece to highlight Flow Chart](imgs\highlightTiles.JPG "Piece to highlight")
...
![Minimax Flow Chart](imgs\Minimax.JPG "Minimax flow")
